...
RSpec.describe GramsController, type: :controller do
    ...
    describe "grams#edit" do
        it "shouldn't allow a use who did not create the gram edit the gram" do
            gram = FactoryBot.create(:gram)
            user = FactoryBot.create(:user)
            sign_in user
    ...
    describe "grams#update" do
        ...
        it "should return the edit form with an http status of unprocessable_entity for validation errors" do
            gram = FactoryBot.create(:gram, message: 'Initial Value')
            sign_in gram.user
    ...
    describe "grams#destroy" do
        ...
        it "should return a 404 error message if the gram with the specified id is not found" do
            user = FactoryBot.create(:user)
            sign_in user
