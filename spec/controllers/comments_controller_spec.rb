...
RSpec.describe CommentsController, type: :controller do
    describe "comments#create action" do
        ...
        it "should return a 404 error message if the gram the person is trying to comment on isn't found" do
            user = FactoryBot.create(:user)
            sign_in user
            
            post :create, params: { gram_id: 'TACOBIRD', comment: { message: 'awesome gram' } }
